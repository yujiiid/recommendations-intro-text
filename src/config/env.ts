...
const envSchema = z.object({
  ...
  AI_GATEWAY_BASE_URL: z.string().url().default('https://gateway.ai.cloudflare.com/v1/f40c46d48669187fc6bb2c53761b7d6b/llm-gateway/compat'),
  AI_GATEWAY_MODEL: z.string().min(1).default('google-vertex-ai/google/gemini-2.5-flash'),
});
